...
def test_save_or_show_salva_quando_output_fornecido():
    ...
    fig = MagicMock()
    with patch("ml.tools.compare_models.os.makedirs"), \
         patch("ml.tools.compare_models.plt.close"):
...
def test_load_best_runs_exit_quando_sem_experimentos():
    ...
    with patch("ml.tools.compare_models.mlflow.set_tracking_uri"), \
...
def test_load_best_runs_retorna_dataframe_com_melhor_run():
    ...
    mock_run.data.metrics = {
        "f1_mean": 0.72, "f1_std": 0.01,
        "roc_auc_mean": 0.88, "recall_mean": 0.84,
        "precision_mean": 0.76, "train_f1_mean": 0.74,
...
def test_load_best_runs_escolhe_melhor_f1_por_modelo():
    ...
    def _run(f1):
        ...
        r.data.metrics = {"f1_mean": f1, "f1_std": 0.0, "roc_auc_mean": 0.85,
                          "recall_mean": 0.80, "precision_mean": 0.75,
                          "train_f1_mean": 0.80, "train_roc_auc_mean": 0.88}
